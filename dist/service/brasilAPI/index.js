!function(global, factory) {
    ...
    _regeneratorRuntime = _interopRequireDefault(_regeneratorRuntime), _axios = _interopRequireDefault(_axios), Object.defineProperty(_exports, "__esModule", {
        value: !0
    }), _exports.BrasilAPIService = void 0;
    var BrasilAPIService = function(CepService) {
        ...
        }(BrasilAPIService, CepService);
        var Derived, hasNativeReflectConstruct, _super = (Derived = BrasilAPIService, hasNativeReflectConstruct = function() {
        ...
        function BrasilAPIService() {
            ...
            }(this, BrasilAPIService), (_this = _super.call(this, "brasilAPI")).baseUrl = "https://brasilapi.com.br/api/cep/v1/", _this;
        }
        return BrasilAPIService.prototype.handler = function(cep) {
            var fn, _this = this;
            return (fn = _regeneratorRuntime.default.mark(function _callee() {
                ...
                return _regeneratorRuntime.default.wrap(function(_ctx) {
                    for(;;)switch(_ctx.prev = _ctx.next){
                        case 0:
                            return _ctx.next = 2, _axios.default.get("".concat(_this.baseUrl).concat(cep));
                        case 2:
