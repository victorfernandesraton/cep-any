!function(global, factory) {
    ...
    _regeneratorRuntime = _interopRequireDefault(_regeneratorRuntime), _axios = _interopRequireDefault(_axios), Object.defineProperty(_exports, "__esModule", {
        value: !0
    }), _exports.ApiCepService = void 0;
    var ApiCepService = function(CepService) {
        ...
        var Derived, hasNativeReflectConstruct, _super = (Derived = ApiCepService, hasNativeReflectConstruct = function() {
        ...
        function ApiCepService() {
            ...
            }(this, ApiCepService), (_this = _super.call(this, "apicep")).baseUrl = "https://ws.apicep.com/cep.json", _this;
        }
        return ApiCepService.prototype.handler = function(cep) {
            var fn, _this = this;
            return (fn = _regeneratorRuntime.default.mark(function _callee() {
                ...
                return _regeneratorRuntime.default.wrap(function(_ctx) {
                    for(;;)switch(_ctx.prev = _ctx.next){
                        case 0:
                            return _ctx.next = 2, _axios.default.get(_this.baseUrl, {
                                params: {
                                    code: cep
                                }
                            });
