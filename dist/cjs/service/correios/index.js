            ...
            value: function (cep) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            return [4, axios_1.default.post("".concat(this.baseUrl, "/SigepMasterJPA/AtendeClienteService/AtendeCliente"), (0, adapters_1.parseParamsToXML)(cep), {
                                    headers: {
                        ...
                        case 3:
                            ...
                            if (typeof error_1 == "string") {
                                ...
                                if (error_1 instanceof Error &&
                                    ...
                                    throw new requestError_1.RequestError("unknow error", this.api);
                                }
                            }
                            return [3, 4];
                        case 4: return [2];
