            ...
            value: function (cep) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            return [4, axios_1.default.get("".concat(this.baseUrl).concat(cep))];
                        case 1:
                            requestData = _a.sent();
                            if (requestData.status != 200) {
                                if (requestData.status >= 400 && requestData.status <= 499) {
                                    throw new requestError_1.RequestError("not found", this.api, requestData);
                                }
                                else {
                                    throw new requestError_1.RequestError("invalid request", this.api, requestData);
                                }
                            }
                            return [4, requestData.data];
                        case 2:
                            data = _a.sent();
                            return [2, (0, adapters_1.responseToCep)(data)];
                        case 3:
                            error_1 = _a.sent();
                            if (typeof error_1 == "string") {
                                ...
                                if (error_1 instanceof Error &&
                                    ...
                                    throw new requestError_1.RequestError("not found", this.api);
                                }
                                else {
                                    throw error_1;
                                }
